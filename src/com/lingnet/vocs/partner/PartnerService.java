 ...
 * @Description: TODO
 * @author zhangyu
 * @date 2017年6月2日 下午3:38:55
 * 
 */

@SuppressWarnings("rawtypes")
public interface PartnerService extends BaseService<Partner, String> {
	/**
	 * 保存或更新
	 * 
	 * @Title: saveOrUpdate
	 ...
	 */
	void saveOrUpdate(Partner partner, String contactsJson, String business) throws Exception;
    ...
    public String getJointData(Pager pager);

    public String saveJoint(String formdata) throws Exception;

    public String getHzcData(Pager pager,String id);

	String getCSQ(String province);

	SewageBusiness getBusinessBySewageId(String id);
}
