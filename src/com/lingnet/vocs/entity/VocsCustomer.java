...
@Entity
@Table(name = "vocs_customer")
public class VocsCustomer extends BaseEntity implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2967019995136614735L;
